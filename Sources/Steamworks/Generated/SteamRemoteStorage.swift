...
public struct SteamRemoteStorage: Sendable {
    ...
    public func commitPublishedFileUpdate(handle: PublishedFileUpdateHandle, completion: @Sendable @escaping (sending RemoteStorageUpdatePublishedFileResult?) -> Void) {
    ...
    public func deletePublishedFile(publishedFileId: PublishedFileID, completion: @Sendable @escaping (sending RemoteStorageDeletePublishedFileResult?) -> Void) {
    ...
    public func enumeratePublishedFilesByUserAction(action: WorkshopFileAction, startIndex: Int, completion: @Sendable @escaping (sending RemoteStorageEnumeratePublishedFilesByUserActionResult?) -> Void) {
    ...
    public func enumeratePublishedWorkshopFiles(enumerationType: WorkshopEnumerationType, startIndex: Int, count: Int, days: Int, tags: [String], userTags: [String], completion: @Sendable @escaping (sending RemoteStorageEnumerateWorkshopFilesResult?) -> Void) {
    ...
    public func enumerateUserPublishedFiles(startIndex: Int, completion: @Sendable @escaping (sending RemoteStorageEnumerateUserPublishedFilesResult?) -> Void) {
    ...
    public func enumerateUserSharedWorkshopFiles(steamId: SteamID, startIndex: Int, requiredTags: [String], excludedTags: [String], completion: @Sendable @escaping (sending RemoteStorageEnumerateUserPublishedFilesResult?) -> Void) {
    ...
    public func enumerateUserSubscribedFiles(startIndex: Int, completion: @Sendable @escaping (sending RemoteStorageEnumerateUserSubscribedFilesResult?) -> Void) {
    ...
    public func fileReadAsync(file: String, offset: Int, toReadSize: Int, completion: @Sendable @escaping (sending RemoteStorageFileReadAsyncComplete?) -> Void) {
    ...
    public func fileShare(file: String, completion: @Sendable @escaping (sending RemoteStorageFileShareResult?) -> Void) {
    ...
    public func fileWriteAsync(file: String, data: UnsafeRawPointer, dataSize: Int, completion: @Sendable @escaping (sending RemoteStorageFileWriteAsyncComplete?) -> Void) {
    ...
    public func getPublishedFileDetails(publishedFileId: PublishedFileID, maxSecondsOld: Int, completion: @Sendable @escaping (sending RemoteStorageGetPublishedFileDetailsResult?) -> Void) {
    ...
    public func getPublishedItemVoteDetails(publishedFileId: PublishedFileID, completion: @Sendable @escaping (sending RemoteStorageGetPublishedItemVoteDetailsResult?) -> Void) {
    ...
    public func getUserPublishedItemVoteDetails(publishedFileId: PublishedFileID, completion: @Sendable @escaping (sending RemoteStorageGetPublishedItemVoteDetailsResult?) -> Void) {
    ...
    public func publishVideo(videoProvider: WorkshopVideoProvider, videoAccount: String, videoIdentifier: String, previewFile: String, consumerAppId: AppID, title: String, description: String, visibility: RemoteStoragePublishedFileVisibility, tags: [String], completion: @Sendable @escaping (sending RemoteStoragePublishFileProgress?) -> Void) {
        let tmpTags = StringArray(tags)
        defer { tmpTags.deallocate() }
    ...
    public func publishWorkshopFile(file: String, previewFile: String, consumerAppId: AppID, title: String, description: String, visibility: RemoteStoragePublishedFileVisibility, tags: [String], workshopFileType: WorkshopFileType, completion: @Sendable @escaping (sending RemoteStoragePublishFileProgress?) -> Void) {
        let tmpTags = StringArray(tags)
        defer { tmpTags.deallocate() }
    ...
    public func setUserPublishedFileAction(publishedFileId: PublishedFileID, action: WorkshopFileAction, completion: @Sendable @escaping (sending RemoteStorageSetUserPublishedFileActionResult?) -> Void) {
    ...
    public func subscribePublishedFile(publishedFileId: PublishedFileID, completion: @Sendable @escaping (sending RemoteStorageSubscribePublishedFileResult?) -> Void) {
    ...
    public func ugcDownload(content: UGCHandle, priority: Int, completion: @Sendable @escaping (sending RemoteStorageDownloadUGCResult?) -> Void) {
    ...
    public func ugcDownloadToLocation(content: UGCHandle, location: String, priority: Int, completion: @Sendable @escaping (sending RemoteStorageDownloadUGCResult?) -> Void) {
    ...
    public func unsubscribePublishedFile(publishedFileId: PublishedFileID, completion: @Sendable @escaping (sending RemoteStorageUnsubscribePublishedFileResult?) -> Void) {
    ...
    public func updateUserPublishedItemVote(publishedFileId: PublishedFileID, voteUp: Bool, completion: @Sendable @escaping (sending RemoteStorageUpdateUserPublishedItemVoteResult?) -> Void) {
