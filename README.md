...
* 13/27 interfaces complete - see [early docs](https://johnfairh.github.io/swift-steamworks/index.html),
...
ISteamGameServerStats, ISteamHTTP, ISteamMatchMaking, ISteamParties, ISteamUser,
