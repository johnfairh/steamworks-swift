...
* 12/27 interfaces complete - see [early docs](https://johnfairh.github.io/swift-steamworks/index.html),
...
ISteamHTTP, ISteamMatchMaking, ISteamParties, ISteamUser, ISteamUserStats, ISteamUtils

Easy:
* ISteamGameSearch, ISteamMusic,
