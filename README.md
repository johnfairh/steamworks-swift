...
* 22/27 interfaces complete - see [early docs](https://johnfairh.github.io/swift-steamworks/index.html),
...
ISteamParties, ISteamRemotePlay, ISteamScreenshots, ISteamUser, ISteamUserStats,
ISteamUtils, ISteamVideo
